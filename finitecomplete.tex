...
\begin{algorithm}
\caption{Initialisation  adaptive test case with pass-trace.}
\label{algo:aInitP}
...
\begin{algorithm}
\caption{Initialisation  adaptive test case with fail-trace.}
\label{algo:aInitF}
...
\begin{algorithm}
\caption{Initialisation  adaptive test case with given trace and end-state.}
\label{algo:aInit}
