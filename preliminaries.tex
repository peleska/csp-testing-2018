...
two maximal refusals labelling Node\_1. \fxwarning{alcc: $Node_2$ coming
before $Node_1$ is a bit strange, but I wasn't brave enough to change the
figure. Let me know if I can.}
